...
a.disabled {
  ...
  cursor: default;
      ...
      <h2 style="text-align: center;">Football Field Session</h2>
          ...
          @foreach($sessions as $session)
            <tr>
              ...
              <td scope="row">
                ...
                <form method="post" action="/FootballField/{{ $session->id }}">
                  @method('PUT')
                  @csrf
