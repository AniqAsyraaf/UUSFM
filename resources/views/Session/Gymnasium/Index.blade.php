...
a.disabled {
  ...
  cursor: default;
      ...
      <h2 style="text-align: center;">Gymnasium Session</h2>
      ...
      <a href="/Gymnasium/create" class="btn btn-primary mb-3">Create New Gymnasium Session</a>
        ...
        <table class="table table-striped table-sm">
          ...
          @foreach($sessions as $session)
            <tr>
              ...
              <td scope="row">{{$session['sessionCurrCap']}}/{{$session['sessionCapacity']}}</td>
              ...
              <td scope="row">
                ...
                <form method="post" action="/Gymnasium/{{ $session->id }}">
                  @method('PUT')
                  @csrf
